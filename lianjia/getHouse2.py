...
class LianjiaSpider(object):
    ...
    def parsePage(self, url):
        ...
        for pageNum in range(1, maxPage + 1):
            url = "https://sh.lianjia.com/ershoufang/pg{}/".format(pageNum)
        ...
        data.to_csv("Lianjia.csv", encoding='utf_8_sig', index=False, columns=columns)
...
if __name__ == "__main__":
    ...
    Lianjia.parsePage("https://sh.lianjia.com/ershoufang/")
